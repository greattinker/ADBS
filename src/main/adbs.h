...
public:
	...
	void setTable(Table* t){ tables.push_back(t); };
...
public:
	...
	PrecedenceGraphNode* getSubtreeRoot(PrecedenceGraphNode* node);
	PrecedenceGraphNode* normalize(PrecedenceGraphNode* node);
	virtual ~Database();
};
